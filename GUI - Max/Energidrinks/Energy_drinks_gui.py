...
class Energy_drink_gui(tk.Frame):
    ...
    def clear_current_drink_label(self):
        self.label_current_name = tk.Label(self.button_panel, text = 'Navn: ')
        self.label_current_name.grid(row = 0, column = 3)
        self.label_current_producer = tk.Label(self.button_panel, text = 'Producent: ')
        self.label_current_producer.grid(row = 1, column = 3)
        self.label_current_price = tk.Label(self.button_panel, text = 'Pris: ')
        self.label_current_price.grid(row = 2, column = 3)
        self.label_current_type = tk.Label(self.button_panel, text = 'Type: ')
    ...
    def build_GUI(self):
        ...
        self.drinks_label = tk.Label(self.button_panel, text = 'Der er {} registrede energidrikke i databasen'.format(None))
        ...
        self.label_name = tk.Label(self.button_panel, text = 'Navn')
        ...
        self.label_price = tk.Label(self.button_panel, text = 'Pris')
        ...
        producers = self.data.get_producer_list()
        label_producers = tk.Label(self.button_panel, text = 'Producenter')
        label_producers.grid(row = 2, column = 1)
        self.cb_producers = ttk.Combobox(self.button_panel, values = producers, state = 'readonly')
        self.cb_producers.grid(row = 2, column = 2, pady = (0,5))
        types = self.data.get_type_list()
        label_type = tk.Label(self.button_panel, text = 'Type')
        ...
        self.label_producer_name = tk.Label(self.button_panel, text = 'Producentens navn')
        ...
        self.label_producer_location = tk.Label(self.button_panel, text = 'Producentens lokation')
        ...
        self.label_producer = tk.Label(self.button_panel, text = 'Producent')
