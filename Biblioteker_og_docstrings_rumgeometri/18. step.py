...
'''
Opgave 18
      Tilføj formel for projektion af punkt på linje & skæring mellem to linjer (Husk to linjer i rummet ikke altid skærer hinanden)
'''
